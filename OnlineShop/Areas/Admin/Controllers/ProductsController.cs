...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,FullDesc,Price,Discount,ImageName,Qty,Tags,VideoUrl")] Product product, IFormFile? MainImage, IFormFile[]? GaleryImage)
        {
            if (ModelState.IsValid)
            {
                ...
                if (GaleryImage != null)
                {
                    foreach (var item in GaleryImage)
                    {

...
namespace OnlineShop.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult RecoveryPassword(RecoveryPasswordViewModel recoveryPassword)
        {
            ...
            mail.From = new MailAddress("ahmedhassansaad902@gmail.com");
            mail.To.Add(foundUser.Email);
            mail.Subject = "Recovery code";
            mail.Body = "Dear user, Your recovery code is :" + foundUser.RecoveryCode;

            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("ahmedhassansaad902@gmail.com", "wogm lhvq tncl kame ");
